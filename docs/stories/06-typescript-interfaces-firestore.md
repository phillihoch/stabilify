...
**WHAT:** Möchte ich typsichere TypeScript Interfaces für alle Firestore Collections (tenants, apiKeys, failures, solutions) definieren
...
- TypeScript Interfaces für alle Firestore Collections (tenants, apiKeys, failures, solutions) sind gemäß Architekturplan definiert
- **Failure Interface** enthält `reportId` zur Gruppierung aller Failures eines Test-Runs
...
- Enums für wiederkehrende Werte sind definiert (z.B. ApiKeyScope, FailureStatus, SolutionCategory)
...
✅ Ja. Es handelt sich um eine klar abgegrenzte Aufgabe mit definiertem Umfang (4 Collections, bekannte Felder aus Architekturplan).

**Small – Ist die Story klein genug für eine Iteration?**
✅ Ja. Die Implementierung sollte in 2-3 Stunden abgeschlossen sein.
